...
?>
<?php 
$select = "SELECT doctors.id , doctors.name doctor , departments.name department FROM doctors JOIN departments ON doctors.departmentId = departments.id";
        ...
        <div class="card-body">
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <th> <a onclick="return confirm('are your sure !!')" href="/frhospital/doctors/list.php?delete=<?php echo $data['id'] ?>"
                            class="btn btn-danger">Delete </a> </th>
                            <th> <a  href="/frhospital/doctors/add.php?edit=<?php echo $data['id'] ?>"
